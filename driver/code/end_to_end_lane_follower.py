...
class EndToEndLaneFollower(object):
    ...
    def __init__(self,
                 car=None,
                 model_path='/home/sunil/Documents/lane_navigation_final_1.h5'):
...
def test_video(video_file):
	...
	#out1 = cv2.VideoWriter('/home/sunil/Documents/output.avi', -1, 20.0, (320,240))
	#out2 = cv2.VideoWriter('/home/sunil/Documents/output.avi', -1, 20.0, (320,240))
    ...
    video_overlay_1 = cv2.VideoWriter("%s_hand_coded.avi" % video_file, video_type, 20.0, (320, 240))
    try:
        i = 0
        while cap.isOpened():
            _, frame = cap.read()
			...
			#out1.write(combo_image1)
			#out2.write(combo_image2)
            cv2.imwrite('/home/sunil/Documents/endtoend.png',combo_image2)
            cv2.imwrite('/home/sunil/Documents/handcoded.png',combo_image1)
...
if __name__ == '__main__':
    ...
    test_video('/home/sunil/Desktop/car_training_data/VIDEOS/car_video200313_173005')
